module SapphireCms
  module Api
    class ContentBlocksController < BaseController
      ...
      def create
        @block = ContentBlock.new(@params["content_block"].permit(:title, :body, :slug, :layout_block_slug, :status, :version, :precache, :controller))
      ...
      def update
        ...
        ensure_valid_update @block do
          ensure_unique do
            if @block.update_attributes(@params["content_block"].permit(:title, :body, :slug, :layout_block_slug, :status, :version, :precache, :controller))
